...
Route::get('/pelicula/{id}', [PeliculaController::class, 'detalles'])->name('pelicula.detalles');Route::delete('/pelicula/{id}', [PeliculaController::class, 'eliminar'])->name('pelicula.eliminar');
Route::delete('/pelicula/{id}', [PeliculaController::class, 'eliminar'])->name('pelicula.eliminar');
Route::put('/pelicula/{id}', [PeliculaController::class, 'modificar'])->name('pelicula.modificar');
Route::post('/pelicula', [PeliculaController::class, 'aniadir'])->name('pelicula.aniadir');
Route::post('/sesion/crear', [PeliculaController::class, 'crearsesion'])->name('sesion.crearsesion');
